...
# _second_login(['http://vip.win007.com/AsianOdds_n.aspx?id=1738578'
# ],
# 'http://vip.win007.com/AsianOdds_n.aspx?id=1793722')
with open('data2.csv', 'r', encoding='utf_8_sig') as fr:
    with open('data8.csv', 'w', encoding='utf_8_sig', newline='') as fw:
        data = []
